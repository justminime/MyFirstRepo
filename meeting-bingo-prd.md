...
> ✅ Audio never leaves device · ✅ No server transmission · ✅ No recording or storage · ✅ Transcription discarded immediately after processing
...
flowchart LR
    ...
    B --> C[Game Active]
    C --> D[Win Screen]
    C -->|if no win| E[Continue or Reset]
```
